...
public class FlatFileReader {
	...
	public ArrayList<Person> readPersons() {
		...
		try {
			sc = new Scanner(new File("Assignment-2-master/data/Persons.dat"));
	...
	public ArrayList<Customer> readCustomer() {
		...
		try {
			sc = new Scanner(new File("Assignment-2-master/data/Customers.dat"));
			sc.nextLine(); // reads the number of records from the first line
	...
	public ArrayList<Product> readProduct() {
		...
		try {
			sc = new Scanner(new File("Assignment-2-master/data/Products.dat"));
			sc.nextLine(); // reads the number of records from the first line
			...
			while (sc.hasNext()) {
				...
				if (proType.charAt(0) == 'L') {
					...
					entities.Product.Services.Parking product = new Product.Services.Parking(code, proType, cost);
					productList.add(product);
				} else if (proType.charAt(0) == 'A') {
					String parkingfee = data[2];
					entities.Product.Services.Amenity product = new Product.Services.Amenity(code, proType, parkingfee);
					productList.add(product);
				}
