...
public class FlatFileReader {
	...
	Address addressobj = new Address(street, city, state, zip, country);
	entities.Product.Lease product = new Product.Lease(code, proType,startDate,endDate,addressobj,customerName,deposit,monthlycost);
	productList.add(product);
		...
		Address addressobj = new Address(street, city, state, zip, country);
	entities.Product.Sale product = new Product.Sale(code, proType,
			dateTime,addressobj,totalCost,downPayment,
